							...
							<section class="shop-widget">
								...
								<ul class="list-unstyled category-list">
									@foreach ($categorydata as $key => $value)
										<li>
											<a href="{{url('/')}}/lelang?sort=ASC&sortfield=name&category={{$value->id_category}}&keyword={{$keyword}}">
										...
										<li>
											...
											<div class="drop">
												<ul class="list-unstyled">
													<li><a href="{{url('/')}}/lelang?sort=ASC&sortfield=name&category={{$category}}&keyword={{$keyword}}">ASC</a></li>
													<li><a href="{{url('/')}}/lelang?sort=DESC&sortfield=name&category={{$category}}&keyword={{$keyword}}">DESC</a></li>
													<li><a href="{{url('/')}}/lelang?sort=DESC&sortfield=price&category={{$category}}&keyword={{$keyword}}">Harga Tertinggi</a></li>
													<li><a href="{{url('/')}}/lelang?sort=ASC&sortfield=price&category={{$category}}&keyword={{$keyword}}">Harga Terendah</a></li>
												</ul>
											</div>
										</li>
	...
	<script type="text/javascript">
		$("#keyword").on('keyup', function (e) {
			if (e.key === 'Enter' || e.keyCode === 13) {
					window.location.href = "{{url('/')}}/lelang?sort=ASC&sortfield=name&category={{$category}}&keyword="+$('#keyword').val()+"";
			}
		});
	</script>
@endsection
