              ...
              <table class="table table-bordered table-striped table-hover" id="table_perdin">
                ...
                <tbody>
                  @foreach ($perdindt as $key => $value)
                    <?php
                      $total = 0;
                      $total += $value->pd_jumlah;
                    ?>
                    <tr>
                      <td><input class="form-control form-control-sm datepicker" value="{{date('d-m-Y')}}" type="text" name="tanggal[]"></td>
                      <td><input class="form-control form-control-sm" value="{{$value->pd_keterangan}}" type="text" name="keterangan[]"></td>
                      <td><input class="form-control form-control-sm mask text-right format_money estimasi" onkeyup="sync({{$key}})" id="estimasi{{$key}}" value="{{number_format($value->pd_jumlah,0,',','.')}}" type="text" name="estimasibudget[]"></td>
                      <td><input class="form-control form-control-sm" id="unit{{$key}}" onkeyup="sync({{$key}})" type="number" min="0" name="unit[]"></td>
                      <td><input class="form-control form-control-sm mask text-right format_money" id="price{{$key}}" onkeyup="sync({{$key}})" type="text" name="price[]"></td>
                      <td><input class="form-control form-control-sm mask text-right format_money" readonly id="totalprice{{$key}}" type="text" name="totalprice[]"></td>
                      <td><input class="form-control form-control-sm mask text-right format_money" readonly id="sisaperdin{{$key}}" type="text" name="sisaperdin[]"></td>
