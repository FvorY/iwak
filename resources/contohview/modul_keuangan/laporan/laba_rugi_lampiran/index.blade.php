...
<html>
	<head>
		...
		<title>Laporan Laba Rugi Lampiran</title>
				...
				<div id="contentnya">
					...
					{{-- Judul Kop --}}
						...
						<table width="100%" border="0" style="border-bottom: 1px solid #333;" v-if="pageNow == 1" v-cloak>
				          <thead>
				            <tr>
				              <th style="text-align: left; font-size: 14pt; font-weight: 600; padding-top: 10px;" colspan="2">Laporan Laba Rugi Lampiran</th>
				            </tr>
    	...
    	<script type="text/javascript">
			...
			var app = 	new Vue({
				            ...
				            mounted: function(){
				            	...
				            	axios.get('{{route('laporan.keuangan.laba_rugi_lampiran.data_resource')}}?'+that.url.searchParams)
			                            .then((response) => {
